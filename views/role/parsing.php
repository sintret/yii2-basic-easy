...
$this->title='Parsing / Upload  role excel';
...
<div class="sintret-update">
    ...
    <div class="role-form">
        ...
        <div class="role-form">
            ...
            <div class="notifications" style="display: none">Please wait, while loading.... <img src="/kueijo/web/img/loadingAnimation.gif"></div>
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('role/sample');?>">role.xls</a>
        </div>
